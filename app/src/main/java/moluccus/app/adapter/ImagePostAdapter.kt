...
/*
 * Copyright (c) 2023 La Niina
 *
 * This code is the property of Moluccus.
 * Any unauthorized use or redistribution is strictly prohibited.
 *
 * For inquiries, please contact la.niina.me@gmail.com.
 */

class ImagePostAdapter(var context: Context, var comments: List<Imagedecoderers>) :
    RecyclerView.Adapter<ImagePostAdapter.CommentViewHolder>() {
